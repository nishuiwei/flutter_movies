        ...
        child: Stack(
          children: [
            ...
            Positioned(
              ...
              child: Container(
                height: screenHeight * 0.5,
                transform: Matrix4.translationValues(0, -screenWidth * 0.05, 0),
                child: Column(
                  ...
                  children: [
                    SizedBox(
                      ...
                      child: Column(
                        children:  [
                          ...
                          Text('2021Action-Adventure-Fantansy*2h36m', textAlign: TextAlign.center, 
                          style: TextStyle(
                            fontSize: 24,
                            fontWeight: FontWeight.w700,
                            color: Constants.kWhiteColor.withOpacity(0.85)  
                          ...
                          RatingBar.builder(
                            ...
                            itemBuilder: ((context, index) => const Icon(Icons.star, color: Constants.kYellowColor,)),
                            onRatingUpdate: ((rating) => {
                              debugPrint(rating.toString())
                            }),
                            unratedColor: Constants.kWhiteColor,
                          ),
                          Text('The saga of the Eternals, a raceof \n immortal beings who lived on Earth \n and shaped its history and \n civilizations.', 
                    ...
                    Container(
                      ...
                      color: Constants.kWhiteColor.withOpacity(0.1),
                    ),
                    SizedBox(
                      height: screenHeight * 0.01,
                    ),
                          ...
                          Row(
                            ...
                            children: [
                              CircleAvatar(
                                ...
                                backgroundImage: const NetworkImage('https://image.weihuijieonline.com/1658332809737.jpeg'),
                              ),
                              Expanded(
                                child: Container(
                                  width: 120,
                                  ...
                                  child: Stack(
                                    ...
                                    children: const [
                                      MaskedImage(asset: Constants.kMaskCast, mask: Constants.kMaskCast),
